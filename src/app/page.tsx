...
const locutores = [
    { id: 1, nome: 'Silvia Fogaça', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=1499&v=1', estilos: ['Padrão', 'Animada', 'Varejo'] },
    { id: 2, nome: 'Charles Helfer', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=1875&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo', 'Caricata'] },
    { id: 3, nome: 'Denilson Soares', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=3199&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo'] },
    { id: 4, nome: 'Rogerio Britto', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=360&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo'] },
    { id: 5, nome: 'Jorge', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=1948&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo', 'Caricata'] },
    { id: 6, nome: 'Andre William', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=87&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo', 'Caricata', 'Outro'] },
    { id: 7, nome: 'Jana Hanauer', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=5793&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo'] },
    { id: 8, nome: 'Sara Luiza', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=5720&v=1', estilos: ['Padrão', 'Animada', 'Varejo', 'Caricata'] },
    { id: 9, nome: 'JC', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=680&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo'] },
    { id: 10, nome: 'Pablo Siqueira', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=3358&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo', 'Caricata'] },
    { id: 11, nome: 'Patricia Trezzi', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=5061&v=1', estilos: ['Padrão', 'Animada', 'Varejo'] },
    { id: 12, nome: 'Patricia Vieira', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=1714&v=1', estilos: ['Padrão', 'Animada', 'Varejo'] },
    { id: 13, nome: 'Donato De Paula', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=5257&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo'] },
    { id: 14, nome: 'Jonas Moreira', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=2420&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo'] },
    { id: 15, nome: 'Elissandra Lima', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=570&v=1', estilos: ['Padrão', 'Animada', 'Varejo'] },
    { id: 16, nome: 'Lula Muniz', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=222&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo', 'Caricata'] },
    { id: 17, nome: 'Antonio Manoel', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=176&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo'] },
    { id: 18, nome: 'Anderson Henrique', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=183&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo', 'Caricata', 'Outro'] },
    { id: 19, nome: 'Robson Ferreira', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=4568&v=1', estilos: ['Padrão', 'Animada', 'Varejo'] },
    { id: 20, nome: 'Silva Jr', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=4223&v=1', estilos: ['Padrão', 'Animada', 'Varejo', 'Caricata'] },
    { id: 21, nome: 'Leandro Cruz', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=641&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo'] },
    { id: 22, nome: 'Duda Celino', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=5738&v=1', estilos: ['Padrão', 'Animada', 'Varejo', 'Caricata'] },
    { id: 23, nome: 'Marcos Vinicius', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=3042&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo', 'Caricata'] },
    { id: 24, nome: 'Leo Menezes', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=6193&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo', 'Caricata'] },
    { id: 25, nome: 'Andre Gonzaga', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=1183&v=1', estilos: ['Padrão', 'Animada', 'Varejo', 'Caricata'] },
    { id: 26, nome: 'Wisley', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=4982&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo', 'Outros'] },
    { id: 27, nome: 'Sunshine', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=64&v=1', estilos: ['Padrão', 'Animada', 'Varejo'] },
    { id: 28, nome: 'Tito Maciel', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=1125&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo'] },
    { id: 29, nome: 'Frank Barone', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=6185&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo'] },
    { id: 30, nome: 'Camargo Varejao', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=5702&v=1', estilos: ['Impacto', 'Animada', 'Varejo'] },
    { id: 31, nome: 'Diane', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=338&v=1', estilos: ['Padrão', 'Animada', 'Varejo'] },
    { id: 32, nome: 'Hellen Reis', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=5017&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo', 'Caricata'] },
    { id: 33, nome: 'Josimai', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=5758&v=1', estilos: ['Padrão', 'Animada', 'Varejo'] },
    { id: 34, nome: 'Priscila Santos', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=5159&v=1', estilos: ['Padrão', 'Animada', 'Varejo'] },
    { id: 35, nome: 'Fernanda Petter', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=1899&v=1', estilos: ['Padrão', 'Animada', 'Varejo'] },
    { id: 36, nome: 'Bruninho Vox', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=1&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo', 'Outro'] },
    { id: 37, nome: 'Washington Luis', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=5864&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo', 'Outros'] },
    { id: 38, nome: 'Maximo', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=1307&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo'] },
    { id: 39, nome: 'Emerson Costa', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=3423&v=1', estilos: ['Padrão', 'Animada', 'Varejo'] },
    { id: 40, nome: 'Lindy', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=698&v=1', estilos: ['Padrão', 'Animada', 'Varejo'] },
    { id: 41, nome: 'Alan Leandro', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=488&v=1', estilos: ['Padrão', 'Animada', 'Varejo', 'Caricata'] },
    { id: 42, nome: 'Brandão', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=1387&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo'] },
    { id: 43, nome: 'Bobby', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=5841&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo'] },
    { id: 44, nome: 'Absamira Santos', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=2052&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo', 'Caricata'] },
    { id: 45, nome: 'Kavanhac', demoUrl: 'https://hd.paineldegravacao.com.br/demos/0713316001537166059.mp3', estilos: ['Padrão', 'Impacto', 'Outros'] },
    { id: 46, nome: 'Rafael Monson', demoUrl: 'https://vozlocutor.com.br/download-audio.php?id=456&v=1', estilos: ['Padrão', 'Impacto', 'Animada', 'Varejo'] },
];
...
export default function Home() {
  ...
  const estilosDeLocucaoDisponiveis = useMemo(() => {
    if (locutorSelecionado && locutorSelecionado.estilos.length > 0) {
      return locutorSelecionado.estilos;
    }
    // Se o locutor não tiver estilos definidos, retorna um array vazio para não mostrar opções
    return locutorSelecionado ? [] : todosOsEstilos;
  }, [locutorSelecionado]);
    ...
    <div className="bg-[#F5F5F5] text-gray-800 min-h-screen">
      <div className="container mx-auto p-4 md:p-8">
        ...
        <section id="video-tutorial" className="mb-16">
          ...
          <div className="aspect-video bg-gray-200 rounded-xl shadow-lg max-w-4xl mx-auto overflow-hidden mb-12">
             <video 
